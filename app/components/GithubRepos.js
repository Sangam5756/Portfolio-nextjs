...
const GithubProjects = () => {
    ...
    const [readmeLoading, setReadmeLoading] = useState(false); // 🆕 Loader state

    const username = "Sangam5756"; // your GitHub username
    ...
    useEffect(() => {
        const fetchRepos = async () => {
            ...
            // Check if cache is available and still valid (within 1 hour = 3600000 ms)
