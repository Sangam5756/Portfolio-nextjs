                ...
                >
                  ...
                  <div className="flex justify-between">
                    <Link
                      ...
                      className="text-green-400 hover:underline lg:text-sm text-xs"
                    >
                      Read More →
                    </Link>
                    <Link
                      href={`https://github.com/Sangam5756/learning-journey/blob/main/blogs/${log.name}`}
                      className="text-blue-400 hover:underline lg:text-sm text-xs"
                      target="_blank"
                    >
                      View on Github ↗
                    </Link>
